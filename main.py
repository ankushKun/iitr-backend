...
def register():
    ...
    DB[cogniid] = {"pid": pid, "pidqr": pidqr, "img_url": f"https://{pid}.ipfs.dweb.link/", "name": name,
                   "email": email, "cogni_id": cogniid, "address": address}
    ...
    print(metadata)
    response = requests.post("https://falling-broken-glade.solana-devnet.discover.quiknode.pro/1c32aed1b5093f00f58b940bbccdc99391b867ea/",
...
def verify():
    ...
    obj = DeepFace.verify(
        faces, img2_path=verifier_img_path, enforce_detection=False)
